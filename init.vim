...
" Treesitter
Plug 'nvim-treesitter/nvim-treesitter'   "Treesitter-based highlighting (right)
Plug 'nvim-treesitter/playground'        "View treesitter information directly in Neovim!


" Pretty Dress
Plug 'bpietravalle/vim-bolt'             "vim syntax highlighting for firebase-bolt
Plug 'theniceboy/nvim-deus'              "vim-deus with treesitter support
